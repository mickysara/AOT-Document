...
<a id = "opensidebar" onclick="openNav()" align="left" class="btn btn-sm btn-dark" href="#" style="font-size: 14px; display:none">
  ...
  <div id="inputs-alternative-component" class="tab-pane tab-example-result fade active show" role="tabpanel" aria-labelledby="inputs-alternative-component-tab">
        <form name="view" id="view_form" method="post">
                <h1 class="display-2" style="color:#2d3436;">ตางรางเอกสารในกิจกรรม</h1>
                <hr>
              ...
              <table class="table align-items-center table-flush" id="Filetable">
                ...
                <?php
                  ...
                  <tr>
                            ...
                            <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
                                <div class="modal-content" style="color: #2d3436;">
                                    ...
                                    <div class="modal-footer">
                                        <a href="<?php echo site_url(); ?>EditController/editrepo/<?php echo $data['Id_UploadInRepository'];?>"class="btn btn-success">Edit</a>
                    ...
                    <td>
                    <a href="<?php echo site_url(); ?>/ViewFileRepositoryController/del/<?php echo $data['Id_UploadInRepository'];?>" onclick="return confirm('คุณต้องการลบไฟล์นี้ใช่หรือไม่ ?')" class="btn btn-danger mb-3">Delete</a>
                    </td>   
                  </tr>
                  <?php } endif; ?> 
                </tbody>
